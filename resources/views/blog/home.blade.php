	        ...
	        <li id="{{ $blog->id }}">
                <div>
	                ...
	                <div class="title col-sm-8">
		                ...
		                <br>
		                <?php $d = Carbon\Carbon::parse($blog->created_at); ?>
		                <div class="author">
		                ...
		                <div class="tagz">
		                  ...
		                  @endforeach
		                  <span class="stars"><i class="icon icon-star"></i>{{ count($blog->stars) }}</span>
		                </div>
	                </div>
	            </div>
	        </li>
    ...
    <div class="col-md-5">
		...
		<h2 class="title text-right">TRENDING</h1>
 		...
 		<div class="grid">
	        ...
	        <?php
			    $trending = \App\Blog::select(DB::raw('blogs.*, count(*) as `aggregate`'))
